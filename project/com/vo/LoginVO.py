...
class LoginVO(db.Model):
    ...
    loginUsername = db.Column('loginUsername', db.String(500), nullable=False)
    loginPassword = db.Column('loginPassword', db.String(500), nullable=False)
    loginRole = db.Column('loginRole', db.String(50), nullable=False)
